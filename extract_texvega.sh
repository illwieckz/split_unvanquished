...
mappak_remote='git@github.com:UnvanquishedAssets/tex-vega_src.dpkdir'
mappak_mirror="${repo_dir}/tex-vega_src.dpkdir.git"
vega_mirror="${repo_dir}/map-vega.git"
mappak_local="${repo_dir}/tex-vega_src.dpkdir"
final_subdir='main'
main_branch='master'
