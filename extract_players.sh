...
dest_clone="${repo_dir}/res-players_src.dpkdir"
final_subdir='players'
main_branch='master'
...
{
	cat <<-EOF
	scripts/builder.shader
	scripts/human_base.shader
	scripts/human_light.shader
	scripts/human_medium.shader
	scripts/human_naked.shader
	scripts/jetpack.particle
	scripts/level0.shader
	scripts/level1.shader
	scripts/level2.shader
	scripts/level3.shader
	scripts/level4.shader
	EOF
}
